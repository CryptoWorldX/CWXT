...
const string strMessageMagic = "cryptoworldxtoken Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 1)
    {
        ...
        else if(pindexBest->nHeight < 2208)
    {
        nSubsidy = 0 * COIN;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    if(pindexBest->nHeight < 5002033)
    {
        nSubsidy = 10 * COIN;
    }

    else if(pindexBest->nHeight > 5002032)
    {
        nSubsidy = 0 * COIN; 
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "cryptoworldxtoken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "https://cryptoworldx.com Portal official launch 23/12/2016";
        CTransaction txNew;
        txNew.nTime = 1482525308;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1482525308;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 620299 : 620299;
        ...
        assert(block.hashMerkleRoot == uint256("0x016fe96877968974986c4e6a748b6eae46afb45d71e5c2dcdb7aad1c9e42bcb3"));
